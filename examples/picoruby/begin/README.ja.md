...
現在のPicoRuby対応は実験段階です。V2のみを対象とし、Rubyコードを事前コンパイルしてファームウェアへ組み込みます。LED、ボタン、加速度センサーの使用例は [microbit](../microbit/README.ja.md)、複数ファイルの構成は [led-rover](../led-rover/README.ja.md)、より大きなゲームは [magic-circle](../magic-circle/README.ja.md) を参照してください。REPLは未対応です。
